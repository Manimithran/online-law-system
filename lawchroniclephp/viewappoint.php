...
<?php
	$result = mysqli_query($conid, "select a.id,a.userid,name,address,city,a.dt,a.tm from appoint a,publicreg p where a.userid=p.username and a.lawyerid='$_SESSION[rn]'") or die(mysqli_error($conid));
	echo "<br><br><table border='1' align='center'><tr><th colspan='7'>ALLOTTED APPOINTMENTS";
	echo "<tr><th>Id<th>User Id<th>Name<th>Address<th>City<th>Date<th>Time";
