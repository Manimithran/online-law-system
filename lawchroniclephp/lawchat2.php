...
<form action="lawchat2.php" method="post">
...
<form name="f2" action="lawchat2.php" method="post" style="width:48%;margin-left:1%;float:left;">
<table id="gt" style="width:100%;"><tr><th colspan="2">User List</th><!--<th><a href="grouphome.php">Back</a></th>--></tr>
<?php
...
$uname=$_POST['t2'];
mysqli_query($conid,"insert into chat values ('$lawname','$uname','$d','$m')") or die(mysqli_error($conid));
