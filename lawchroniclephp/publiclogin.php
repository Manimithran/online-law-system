            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <div class="content_section">
                  <h2>Public Login</h2>
                <center><img src="images/userlog.gif" alt="Image 01"/></center><form name="publogin" method="post">
                  <table border="2px" cellpadding="20px" align="center">
                  <tr><th>Username</th><td><input type="text" name="pubun" required="required"/></td></tr>
                  <tr><th>Password</th><td><input type="password" name="pubpass" required="required"/></td></tr>
                  <tr><th><input type="submit" name="pubsub" value="Login" /></th><th><input type="reset" name="pubres" value="Reset" /></th></tr>
                  <tr><th colspan="2">NEW USER <a href="publicreg.php">SIGNUP</a></th></tr>
...
extract($_POST);
include("dbcon.php");
$rs1=mysqli_query($conid,"select username,password from publicreg where username='$pubun' and password='$pubpass'") or die(mysqli_error($conid));
