            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <div class="content_section">
				 ...
				 echo $a[0];
				   ?>
				  <a href="publichome.php">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php">Logout</a></h2>
				  <?php
                  
                 if(isset($_SESSION['un']))
				  {
					  $rs=mysqli_query($conid,"select * from inbox where toadd='$a[0]'") or die(mysqli_error($conid));
					  echo "<table border='2px'><tr><th>Delete</th><th>Sender</th><th>Subject</th><th>Send Date</th></tr>";
					 
					 while($a=mysqli_fetch_array($rs))
					 {
						 echo "<tr>";
						 echo "<td><a href='pubdelmail.php'>Delete</a></td>";
						 
							 echo "<td>".$a[0]."</td>";
							 echo "<td><a href='pubmaildisp.php?s=$a[0]&su=$a[2]'>".$a[2]."</a></td>";
							  echo "<td>".$a[3]."</td>";
