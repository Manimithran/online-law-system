            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <div class="content_section">
                  ...
                  <center><a href="grouphome.php">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="loglaw.php">Logout</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ans.php">Click to see answers</a></center>
                  <?php
				  session_start();
				  ...
				  include("dbcon.php");
				  $rs=mysqli_query($conid,"select * from forums order by pdate desc")or die(mysqli_error($conid));
				 $count= mysqli_num_fields($rs);
				 echo "<table border=1px><tr><th>ThreadNo</th><th>Heading</th><th>Description</th><th>Posted Date</th><th>Name</th><th>Answer</th></tr>";
				 while($a=mysqli_fetch_array($rs))
				 {
					...
					$thno=$a[0];
					echo "<td><a href='forumans.php?tn=$thno'>Answer</a></td>";
