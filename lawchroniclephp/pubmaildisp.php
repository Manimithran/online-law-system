            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <div class="content_section">
				 ...
				 echo $a[0];
				   ?>
				  <a href="publichome.php">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="loglaw.php">Logout</a></h2>
                 ...
                 if(isset($_SESSION['un']))
				  {
					  $rs=mysqli_query($conid,"select * from inbox where toadd='$usn' and subject='$subj'") or die(mysqli_error($conid));
