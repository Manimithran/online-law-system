            ...
            <div class="scrollContainer">
              <div class="panel" id="home">
                <div class="content_section">
                  <h2>Client List</h2>
                  <h4><a href="lawyermailcompose.php">Go to Mail Compose</a></h4>
                   <?php
					session_start();
				    include("dbcon.php");
				  $rno=$_SESSION['rn'];
				 ...
				 $_SESSION['lawname']=$a[0];
					...
					{
						$rs=mysqli_query($conid,"select * from addressbook where lawyerid='$rno'") or die(mysqli_error($conid));
						echo "<table border=2px cellpadding='5'><tr><th>Lawyer Id</th><th>Client Name</th><th>Client id</th></tr>";
